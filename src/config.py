...
EXP1_CONFIG = {
    ...
    "iterations_per_position": 10,  # Statistical significance
...
EXP2_CONFIG = {
    "document_counts": [2, 5, 10, 20, 50],  # Varying context sizes
    "words_per_document": 200,
    "iterations_per_size": 5,  # Iterations for each size
...
EXP3_CONFIG = {
    "num_documents": 20,  # Total documents in corpus
